...
import { skillLogos } from '../../../data/Constants.tsx';
	...
	return (
		<ProjectWrapper>
			<InfoWrapper>
				...
				<div className="techsLabel">Technologies used: </div>
				<div className="listedSkills">
					{technologies.map((tech) => (
						<div key={uuidv4()}><img src={skillLogos[tech]} alt="tech logo" /> </div>
					))}
				</div>
			</InfoWrapper>
			<ImageBox>
				<img src={projectImage[tag] || ProjectImg} alt="project overlay background" />
			</ImageBox>
		</ProjectWrapper>
	);
};
